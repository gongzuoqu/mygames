<p>While teaching myself how to use pygame  I discovered a distinct lack of the ability</p>
<p>to handle sprite sheets.  After some digging on the internet I came across a class</p>
<p>that did everything I needed.  I cleaned up the code a bit and added an additional</p>
<p>function to load a strip of images.</p>
...
<br />
<p>Here is a quick example on how you would use this</p>
<br />
<p></p><pre><code class="python">
import spritesheet
...
...
<br />
<p>Here is a sprite strip animation iterator built on spritesheet.spritesheet</p>
<br />
<p></p><pre><code class="python">
import spritesheet
...
<br />
<p>And an example usage of sprite_strip_anim.SpriteStripAnim</p>
<br />
<p></p><pre><code class="python">
"""
...
<br /><br />page migrated to new wiki
